...
config = {
    ...
    'url': 'github.ocm/https://github.com/cups49/python_tutorials/philly_bike_messenger_game',
    'download_url': 'https://github.com/cups49/python_tutorials/philly_bike_messenger_game/',
