...
"""
Exercise 42 from LPTHW
introduction to classes in python
*** basically the same as ex41.py but re-wrote using class ***
"""
...
class Game(object):
    ...
    def central_corridor(self, action):
        ...
        """       
        # action = raw_input("> ") #replaced with function parameter (extra credit)
    ...
    def laser_weapon_armory(self, action):
        ...
        """
        #code = "%d%d%d" % (randint(1,9), randint(1,9), randint(1,9)) # real variable for game, makes it too hard!
